  ...
  const bookData = [
    {
      ...
      description: `Un imprevisible y divertido talk show semanal y en prime time sobre grandes temas, abordados con humor y sentido del espectáculo. Presentado por Xavier Sardà en TVE.`,
      img: Confusion,
      links: [
        {
          linkid: 1,
