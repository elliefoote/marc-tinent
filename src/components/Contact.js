...
const Contact = () => {
  return (
    <div id="contact-me" className="page-section container d-flex flex-column">
      ...
      <div className="contact-box mb-3 d-flex align-items-center justify-content-center flex-column">
        ...
        <div className="d-flex mt-3">
          <div className="my-social-icon d-flex align-items-center justify-content-center me-3">
            ...
            >
              <BsInstagram className="fs-3 text-dark" />
            </a>
          </div>
          <div className="my-social-icon d-flex align-items-center justify-content-center me-3">
            <a
            ...
            >
              <AiTwotoneMail className="fs-2 text-dark" />
            </a>
          </div>
          <div className="my-social-icon d-flex align-items-center justify-content-center me-3">
            <a
